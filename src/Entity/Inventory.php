...
class Inventory
{
    ...
    // Кастомные поля для формата ID (будет JSON или отдельная таблица позже)
    #[ORM\Column(type: Types::JSON, nullable: true)]
    private ?array $customIdFormat = null;

    // Кастомные поля: строковые (single-line text) - до 3 штук
    ...
    // Кастомные поля: многострочный текст (multi-line text) - до 3 штук
    #[ORM\Column(type: Types::BOOLEAN, nullable: true, options: ['default' => false])]
    ...
    // Кастомные поля: числовые (numeric) - до 3 штук
    #[ORM\Column(type: Types::BOOLEAN, nullable: true, options: ['default' => false])]
    ...
    // Кастомные поля: булевы (true/false) - до 3 штук
    #[ORM\Column(type: Types::BOOLEAN, nullable: true, options: ['default' => false])]
    ...
    // Кастомные поля: ссылки (document/image links) - до 3 штук
    #[ORM\Column(type: Types::BOOLEAN, nullable: true, options: ['default' => false])]
    ...
    // Геттеры и сеттеры для кастомных полей (string1-3)
    ...
    // Геттеры и сеттеры для кастомных полей (text1-3)
    ...
    // Геттеры и сеттеры для кастомных полей (int1-3)
    ...
    // Геттеры и сеттеры для кастомных полей (bool1-3)
    ...
    // Геттеры и сеттеры для кастомных полей (link1-3)
